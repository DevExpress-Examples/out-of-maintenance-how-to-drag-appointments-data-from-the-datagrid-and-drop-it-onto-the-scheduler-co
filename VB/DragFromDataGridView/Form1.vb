...
Namespace DragFromDataGridView
    Partial Public Class Form1
        ...
        Private Sub dataGridView1_MouseDown(ByVal sender As Object, ByVal e As MouseEventArgs) Handles dataGridView1.MouseDown
            ...
            Me.dragBox = New Rectangle(e.X - dragSize.Width \ 2, e.Y - dragSize.Height \ 2, dragSize.Width, dragSize.Height)
        End Sub
        ...
        Private Sub DoDrag()
            ' Initialize Car data.
            Dim row As DataRow = carsDBDataSet_Renamed.Tables(0).Rows(dataGridView1.CurrentRow.Index)
        ...
        Private Sub schedulerControl1_DragDrop(ByVal sender As Object, ByVal e As DragEventArgs) Handles schedulerControl1.DragDrop
            If e.Data.GetDataPresent(GetType(CarDragData)) Then
                ...
                DoDrop(pt, DirectCast(e.Data.GetData(GetType(CarDragData)), CarDragData))
            End If
        End Sub
        ...
        Private Sub DoDrop(ByVal point As Point, ByVal data As CarDragData)
            ...
            If hitInfo.HitTest = SchedulerHitTest.Cell Then
                ...
                ' Add an appointment.
                Dim apt As Appointment = schedulerStorage1.CreateAppointment(AppointmentType.Normal, cell.Interval.Start, TimeSpan.FromHours(4))
